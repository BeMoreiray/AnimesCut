...
create table tb_animes_has_avaliation(
 ...
 primary key (id_animes, id_user, id_avaliation)
);
...
ALTER TABLE tb_favorites ADD COLUMN id_typesAnimes INT;
ALTER TABLE tb_favorites ADD CONSTRAINT fk_typesAnimes3 FOREIGN KEY(id_typesAnimes) REFERENCES tb_typesAnimes(id) ON DELETE CASCADE;
